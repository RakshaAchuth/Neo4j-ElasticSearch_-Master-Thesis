#!/bin/bash
DEFAULT_HADOOP_HOME=E:/WISE17/THESIS/hadoop-2.6.0 #change to your hadoop folder
DEFAULT_LDBC_SNB_DATAGEN_HOME=E:/WISE17/THESIS/ldbc_snb_datagen #change to your ldbc_socialnet_dbgen folder
