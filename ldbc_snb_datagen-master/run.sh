#!/bin/bash
DEFAULT_HADOOP_HOME="/home/raksha/hadoop-2.6.0" #change to your hadoop folder
DEFAULT_LDBC_SNB_DATAGEN_HOME="/home/raksha/ldbc_snb_datagen-master" #change to your ldbc_socialnet_dbgen folder
